...
;;; 
(if (and is-xemacs (not is-ms-windows))
    (progn
     (setq
      crypt-encryption-type 'pgp	; default encryption mechanism
      crypt-confirm-password t		; make sure new passwords are correct
      ;;crypt-never-ever-decrypt t 
					; if you don't encrypt anything,
	                                ; set this to tell it not to assume
	                                ; that "binary" files are encrypted
